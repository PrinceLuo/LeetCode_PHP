...
<html>
    <head>
        ...
        <link rel="icon" href="http://<?php echo $_SERVER['SERVER_NAME'].':'.$_SERVER["SERVER_PORT"]; ?>/public/img/webpage_pic_icon/favicon-16x16.png" type="image/png" sizes="16x16">
        <link rel="icon" href="http://<?php echo $_SERVER['SERVER_NAME'].':'.$_SERVER["SERVER_PORT"]; ?>/public/img/webpage_pic_icon/favicon-32x32.png" type="image/png" sizes="32x32">
